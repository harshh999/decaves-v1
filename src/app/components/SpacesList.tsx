                ...
                <div className="space-img-clip relative aspect-[4/3] overflow-hidden bg-brown-dark/10">
                  ...
                  <div className="absolute bottom-5 left-5 z-10 opacity-0 translate-y-2 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] group-hover:opacity-100 group-hover:translate-y-0 hidden md:block">
                    <span className="font-sans text-[10px] tracking-[0.2em] uppercase font-semibold text-white bg-[#2C1A11]/60 backdrop-blur-md px-3.5 py-2 rounded border border-white/5">
                      {getProjectCategoryAndYear(project.slug)}
                    </span>
                  </div>
                </div>
              </div>
...
function getProjectCategoryAndYear(slug: string) {
  const meta: Record<string, string> = {
    "spinal-stone": "Residential / 2026",
    "ankur-bhai": "Residential / 2026",
    "anhaya-store-kolhapur": "Retail / 2025",
    "suramya-altis": "Residential / 2026",
    "colortek-bhayli": "Commercial / 2026",
    "panchal-residence-sama": "Residential / 2025",
    "thavrani-residence": "Residential / 2025",
    "vayu-villa": "Residential / 2025",
    "arpita-sidhhpura": "Residential / 2026",
    "cafe-lemon": "Commercial / 2026",
  };
  return meta[slug] || "Architecture / 2026";
}